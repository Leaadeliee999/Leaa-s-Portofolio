...
const AboutSection = () => {
    ...
    return (
        <section id="About" ref={sectionRef} className="h-screen relative overflow-hidden bg-gradient-to-b from-black to-[#9a74cf50]">
            ...
            <div className="container mx-auto px-4 h-full flex flex-col items-start justify-center pl-8">
                <h1 ref={titleRef} className="text-4xl md:text-6xl font-bold sm:mb-16 text-white opacity-0">
                    About Me
                </h1>
            </div>
